...
# датасет, разделять его на два датасета по признаку: "Вид расчета"
# где деление происходит на "наличный" и "безналичный", и сохранять 
...
# Создание метода для обработки и фильтра данных файла
    def sorting(self):
        ...
        filtered1_df = df[df['Вид расчета'] == 'наличный']
        filtered2_df = df[df['Вид расчета'] != 'наличный']
